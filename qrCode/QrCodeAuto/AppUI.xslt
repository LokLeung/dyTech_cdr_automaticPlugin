...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:frmwrk="Corel Framework Data">
  ...
  <xsl:template match="uiConfig/items">
    <xsl:copy>
      ...
      <itemData guid="b757ee76-e0dc-4850-a0a6-ef05fe94bc01"
                type="wpfhost"
                hostedType="Addons\QrCodeAuto\QrCodeAuto.dll,QrCodeAuto.ControlUI"
                enable="true"/>
    ...
    <xsl:copy>
      <xsl:apply-templates select="node()|@*"/>
        ...
        <container>
          ...
          <item dock="fill" margin="0,0,0,0" guidRef="b757ee76-e0dc-4850-a0a6-ef05fe94bc01"/>
        </container>
